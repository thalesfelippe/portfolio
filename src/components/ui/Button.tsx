...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  secondary:
    'border-violet/16 bg-[#fbfaff]/76 text-dark-text shadow-[0_10px_30px_rgba(31,17,71,0.055)] backdrop-blur-md hover:-translate-y-0.5 hover:border-violet/30 hover:bg-[#f7f3ff] hover:shadow-[0_16px_40px_rgba(31,17,71,0.085)] dark:border-white/10 dark:bg-white/8 dark:text-white dark:hover:border-soft-lavender/25 dark:hover:bg-white/12',
  ghost:
