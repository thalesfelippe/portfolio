    ...
    >
      ...
      <div className="grid gap-4 md:grid-cols-3">
        {t.resumeSection.buttons.map((button, index) => {
          ...
          return (
            <Card
              className="group relative overflow-hidden p-4 transition duration-300 hover:-translate-y-0.5 hover:border-violet/25 hover:shadow-[0_24px_70px_rgba(108,43,217,0.11)] motion-reduce:transition-none motion-reduce:hover:translate-y-0 dark:hover:border-soft-lavender/20 sm:p-5"
              key={button.href}
            >
                  ...
                  <div className="grid gap-2">
                    ...
                    <p className="text-sm leading-6 text-muted-text dark:text-slate-300">
                      <LanguageTransitionText
                        as="span"
                        mode="fade"
                        reserveText={[enButton.description, ptButton.description]}
