...
export function AppBackground({ children }: AppBackgroundProps) {
  return (
    <div className="relative min-h-svh overflow-hidden bg-light-bg text-dark-text transition-colors dark:bg-deep-navy dark:text-white">
      ...
      <div className="pointer-events-none absolute -left-28 top-24 h-72 w-72 rounded-full bg-violet/20 blur-3xl dark:bg-violet/30" />
      <div className="pointer-events-none absolute right-[-8rem] top-10 h-96 w-96 rounded-full bg-soft-lavender/35 blur-3xl dark:bg-soft-lavender/15" />
